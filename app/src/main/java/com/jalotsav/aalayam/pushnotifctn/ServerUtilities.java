...
public final class ServerUtilities implements AalayamConstants{
...
/*        String serverUrl = SERVER_URL;
		...
		params.put(FUNCTION_SMALL, FNCTN_UPDATE_REGISTRATION_ID);
		...
		try {
			jsnobj.put(FUNCTION_SMALL, FNCTN_UPDATE_REGISTRATION_ID);
			jsnobj.put(REGISTRATION_ID, regId);
...
//                post(serverUrl, params);
            	...
            	General_Fnctns.logManager(DEBUG, "GCMJson: " + jsnobj.toString());
                ServiceHandler obj_srvchndlr = new ServiceHandler();
                String json = WEBSRVC_JSONKEY + jsnobj.toString();
    			obj_srvchndlr.post_makeServiceCall(json);
...
//            post(serverUrl, params);/*** Here we change ***/
