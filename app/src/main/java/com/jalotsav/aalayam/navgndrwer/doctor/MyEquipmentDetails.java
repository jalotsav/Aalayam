...
public class MyEquipmentDetails extends AppCompatActivity implements AalayamConstants {
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		setContentView(R.layout.lo_doctor_frgmnt_myeqpmnt_details);

		ActionBar actionBar = getSupportActionBar();
		actionBar.setDisplayHomeAsUpEnabled(true);
		actionBar.setElevation(0);
		
		tvTitle = (TextView) findViewById(R.id.tv_dctr_frgmnt_eqpmnt_dtls_title);
		tvAmnt = (TextView) findViewById(R.id.tv_dctr_frgmnt_eqpmnt_dtls_amount);
		tvDate = (TextView) findViewById(R.id.tv_dctr_frgmnt_eqpmnt_dtls_date);
		tvQty = (TextView) findViewById(R.id.tv_dctr_frgmnt_eqpmnt_dtls_quantity);
		tvRate = (TextView) findViewById(R.id.tv_dctr_frgmnt_eqpmnt_dtls_rate);
		tvDscrptn = (TextView) findViewById(R.id.tv_dctr_frgmnt_eqpmnt_dtls_dscrptn);
		...
		tvQty.setText(getIntent().getStringExtra(QTY_SML));
		tvRate.setText(getResources().getString(R.string.symbl_rupee) + " " + getIntent().getStringExtra(RATE_SML));
