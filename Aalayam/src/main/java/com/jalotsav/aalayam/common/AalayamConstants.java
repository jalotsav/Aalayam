...
public interface AalayamConstants {
	...
	public static String EXTRNL_STRG_PATH_STRING = Environment.getExternalStorageDirectory().getAbsolutePath();
	public static File PATH_EXTRNL_STRG = new File(EXTRNL_STRG_PATH_STRING);
	public static File PATH_IMAGES = new File(EXTRNL_STRG_PATH_STRING + FORWARD_SLASH + AALAYAM + FORWARD_SLASH + IMAGES_SMALL);
    public static File PATH_IMAGES_DOCTOR = new File(EXTRNL_STRG_PATH_STRING + FORWARD_SLASH + AALAYAM + FORWARD_SLASH + IMAGES_SMALL + FORWARD_SLASH + DOCTOR_SMALL);
    public static String STRNG_PATH_IMAGES_DOCTOR = EXTRNL_STRG_PATH_STRING + FORWARD_SLASH + AALAYAM + FORWARD_SLASH + IMAGES_SMALL + FORWARD_SLASH + DOCTOR_SMALL;
    public static File PATH_IMAGES_PATIENT_CASE = new File(EXTRNL_STRG_PATH_STRING + FORWARD_SLASH + AALAYAM + FORWARD_SLASH + IMAGES_SMALL + FORWARD_SLASH + PATIENT_SMALL + FORWARD_SLASH + CASE_SMALL);
    public static File PATH_IMAGES_PATIENT_IMAGES = new File(EXTRNL_STRG_PATH_STRING + FORWARD_SLASH + AALAYAM + FORWARD_SLASH + IMAGES_SMALL + FORWARD_SLASH + PATIENT_SMALL + FORWARD_SLASH + IMAGES_SMALL);
    public static String STRNG_PATH_IMAGES_PATIENT_IMAGES = EXTRNL_STRG_PATH_STRING + FORWARD_SLASH + AALAYAM + FORWARD_SLASH + IMAGES_SMALL + FORWARD_SLASH + PATIENT_SMALL + FORWARD_SLASH + IMAGES_SMALL;
    public static File PATH_IMAGES_PATIENT_PROFILE = new File(EXTRNL_STRG_PATH_STRING + FORWARD_SLASH + AALAYAM + FORWARD_SLASH + IMAGES_SMALL + FORWARD_SLASH + PATIENT_SMALL + FORWARD_SLASH + PROFILE_SMALL);
    public static String STRNG_PATH_IMAGES_PATIENT_PROFILE = EXTRNL_STRG_PATH_STRING + FORWARD_SLASH + AALAYAM + FORWARD_SLASH + IMAGES_SMALL + FORWARD_SLASH + PATIENT_SMALL + FORWARD_SLASH + PROFILE_SMALL;
    public static File PATH_IMAGES_PATIENT_VIDEOS = new File(EXTRNL_STRG_PATH_STRING + FORWARD_SLASH + AALAYAM + FORWARD_SLASH + IMAGES_SMALL + FORWARD_SLASH + PATIENT_SMALL + FORWARD_SLASH + VIDEOS_SMALL);
